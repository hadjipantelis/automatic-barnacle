...
if generate_from_raw:
    ...
    p_new_cases = p_new_cases.merge(p_spatial_lexicon[['LSOA11CD','LAD21CD']], right_on="LAD21CD", left_on='areaCode' )
    p_new_cases = p_new_cases.merge(p_age_popul[["LSOA Code",'pop_all_ages']],left_on='LSOA11CD',right_on="LSOA Code")

    lad_pop = p_new_cases[p_new_cases.season =='spring_2021'].groupby('areaCode')['pop_all_ages'].sum().reset_index()
    lad_pop.rename({
